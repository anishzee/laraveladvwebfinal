      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('/newproj')}}">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('/allproject')}}">
              ...
              <span class="menu-title">View All Project</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('/lectinfo')}}">
              ...
              <span class="menu-title">Lecturer Information</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('/svproj')}}">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('/examineeproject')}}">
              <span class="menu-icon">
